...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "Express", "Typescript","flutter"];
  const rightLists = ["NodeJS", "NextJS", "Databases","AWS"];
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-sans font-extralight md:max-w-32 md:text-xs lg:text-base text-sm text-[#363a7a] z-10">
            {description}
          </div>
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-3 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-2">
                ...
                <span className="lg:py-1 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-2">
